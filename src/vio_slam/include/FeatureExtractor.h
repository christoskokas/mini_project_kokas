...
class FeatureExtractor
{
    ...
    public:
        ...
        FeatureExtractor(FeatureChoice _choice = ORB, const int _nfeatures = 1500, const int _nLevels = 5, const float _imScale = 1.3f, const int _edgeThreshold = 15, const int _patchSize = 31, const int _maxFastThreshold = 15, const int _minFastThreshold = 7, const bool _nonMaxSuppression = true);
